...
const AdminWebPage = () => {
  ...
  const downloadImportTemplate = () => {
    const template = [
      { '产品编号': 'BM001', '产品名称': '乌金木沙发', '分类': '乌金木', '型号': 'MJ-001;MJ-002', '尺寸': '180×90×85;200×100×90', '排列方式': 1, '排序权重': 100 },
      { '产品编号': 'BM002', '产品名称': '黑檀木茶几', '分类': '黑檀木', '型号': 'MJ-003', '尺寸': '120×60×45', '排列方式': 2, '排序权重': 50 }
    ]
    downloadExcel(template, '导入模板.xlsx')
  }
  ...
  const downloadDeleteTemplate = () => {
    ...
    downloadExcel(template, '删除模板.xlsx')
  }

  // 下载修改模板
  const downloadUpdateTemplate = () => {
    const template = [
      { '产品编号': 'BM001', '产品名称': '新名称', '分类': '黑檀木', '型号': 'MJ-001', '尺寸': '180×90×85', '排列方式': 2, '排序权重': 200 }
    ]
    downloadExcel(template, '修改模板.xlsx')
  }
